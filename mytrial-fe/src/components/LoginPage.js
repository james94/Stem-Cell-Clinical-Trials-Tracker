...
const loginUser = (username, password, history) => {
  ...
  fetchMytrial(
    ...
    .then((data) => {
      ...
      console.log(
        "Logged in with " + username + password + localStorage.getItem("role")
      );
...
const LoginForm = (props) => {
  ...
  return (
    <Form
      onSubmit={() => {
        loginUser(username, password, props.history);
      }}
    >
      <Form.Field>
      ...
      <div>
        Test Researcher Without Patient Donor:
        <br />
        MarkHumayun
        <br />
        MDAwMTIz
        <br />
        <br />
        Test Researcher With Patient Donor:
        <br />
        TippiMacKenzie
        <br />
        MDAwMTIz
