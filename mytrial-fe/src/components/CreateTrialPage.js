...
const createTrial = (
  ...
  if (
    ...
    fetchMytrial(ADD_TRIAL_END_POINT, null, { method: "POST" }, data, {
      ...
      >
        ...
        <Form.Field required>
          ...
          <input
            ...
            placeholder="0"
            onChange={(e) => {
              setTargetEnroll(e.target.value);
            }}
          />
        </Form.Field>
