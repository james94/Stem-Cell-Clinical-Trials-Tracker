      ...
      <div>
        {
          ...
          this.state.donor && localStorage.getItem("role") === "researcher" ? (
            <Button>
              <Link
                to={{ pathname: `/update_donor/${this.props.match.params.id}` }}
              >
                Update Donor
              </Link>
            </Button>
            ...
            <Button>
              <Link
                to={{ pathname: `/add_donor/${this.props.match.params.id}` }}
              >
                Add Donor
              </Link>
            </Button>
        ...
        <h2>Trial Data</h2>
        {
          <Link to={{ pathname: `/trials/${this.state.trialToShow.trial_id}` }}>
        ...
        <Button>
          <Link to={`/editPatient/${this.props.match.params.id}`}>
            Edit Profile
          </Link>
        </Button>
        {localStorage.getItem("role") === "researcher" && (
          <Button
            onClick={(event) => {
              this.deletePatient(event, this.props.match.params.id);
            }}
          >
            Delete Patient
          </Button>
