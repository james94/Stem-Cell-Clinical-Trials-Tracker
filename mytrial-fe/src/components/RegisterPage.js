...
const registerUser = (
  ...
  fetchMytrial(
    ...
    null,
    { method: "POST" },
    { r_name, r_username, r_password, organization, disease_area }
  )
    .then((data) => {
      console.log(data);
...
const organizationOptions = [
  {
    key: "aspen neuroscience",
    text: "Aspen Neuroscience",
    value: "Aspen Neuroscience",
  },
  {
    key: "semma therapeutics",
    text: "Semma Therapeutics",
    value: "Semma Therapeutics",
  },
  {
    key: "cal state univ, sacramento",
    text: "Cal State Univ, Sacramento",
    value: "Cal State Univ, Sacramento",
  },
  {
    key: "lineage cell therapeutics inc.",
    text: "Lineage Cell Therapeutics Inc.",
